...
function App() {
  ...
  <section className="heading">
    <header className="hero">
      <img src="https://cdn.freecodecamp.org/platform/universal/fcc_meta_1920X1080-indigo.png" alt="freecodecamp logo" loading="lazy" className="hero-img" />
  ...
  <section className="text text-with-images">
    ...
    <aside className="image-wrapper">
      <img src="https://cdn.freecodecamp.org/testable-projects-fcc/images/random-quote-machine.png" alt="image of the quote machine project" loading="lazy" className="image-1" width={600} height={400} />
      <img src="https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png" alt="image of a calculator project" loading="lazy" className="image-2" width={400} height={400} />
      ...
      <img src="https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg" alt="four people working on code" loading="lazy" className="image-3" width={600} height={400} />
    </aside>
  </section>
</main>
